  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-black pt-32">
      <div className="max-w-6xl mx-auto mt-16">
        ...
        <CalendlyButton showHeading={true} className="bg-gradient-to-r from-red-600 via-yellow-500 to-orange-500 hover:opacity-90 text-white px-8 py-6 text-lg rounded-md animate-float" />
      </div>
    </section>
  );
};